...
import com.mycompany.automovil.logica.Automovil_;
...
public class ConsultaAutomovil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTituloConsulta.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        lblTituloConsulta.setText("Consulta de Automóviles ");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(lblTituloConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    //-------------------------------------------------------------------
    // evento para la ventana Consulta Automovil por si agrego un boton de cargar tabla 
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       ...
       if (tablaAutos.getRowCount()>0){
           ...
           if(tablaAutos.getSelectedRow() != -1 ) {
                    ...
                    CargarTabla(); // cargo tabla para actualizar la interfaz grafica con el objetoa ya  eliminado
                    
           }
           
           else { 
               mostrarMensaje("No selecciono un registro para eliminar", "Eror", "Error al eliminar");
           }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (tablaAutos.getRowCount()> 0 ){
            // valido que se haya seleccionado una fila 
           if(tablaAutos.getSelectedRow() != -1 ) {
                    // Id para modificar el auto seleccionado 
                    int idAuto = Integer.parseInt(String.valueOf( tablaAutos.getValueAt(tablaAutos.getSelectedRow(), 0))) ;
                   // creo una nueva instancia de Modificar y le paso el id 
                    ModifAuto modifAuto = new ModifAuto (idAuto);
                    modifAuto.setVisible(true);
                    modifAuto.setLocationRelativeTo(null);
                   
                    // cierra la ventana ConsultarAuto
                    this.dispose();
           
           }
           
            else { 
               mostrarMensaje("No selecciono un registro para modificar", "Eror", "Error al modificar");
           }
        }
    ...
    private void CargarTabla() { // metodo privado que se encarga de actualizar la tabla y cargarlo a la ventana
        ...
        String  titulos []  = {"Id", "Marca", "Patente","Motor","Color","Modelo","Puertas"  } ;
        ...
        // setear los datos a la tabla 
        if (listaAuto != null ){
            for (Automovil auto : listaAuto){
                Object [] Objeto = {auto.getId() , auto.getMarca() , auto.getPatente(),auto.getMotor(),auto.getColor(),
                    auto.getModelo() , auto.getCantPuertas()};
